...
- **Color handling**: saturated colored elements are preserved as black ink in the
  monochrome print raster instead of becoming white.
...
- **Цвета**: насыщенные цветные элементы сохраняются как чёрная графика в
  монохромной печати, а не становятся белыми.
